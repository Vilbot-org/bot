...
import { EmbedBuilder, ActionRowBuilder, ButtonStyle, PermissionsBitField } from "discord.js";
...
export default async (client, interaction) => {
	...
	const existChannel = channels.find(element => {
		return element.name == `「🎵」${config.botName.charAt(0).toLowerCase() + config.botName.slice(1)}-music`;
	});
